...
function getCopy(lang: Lang) {
  return lang === "zh"
    ? {
        ...
        enableMethod: "启用方式",
        helpLabel: "查看启用方式说明",
        appendHelp: "只在 AGENTS.md 中增加 Codex-X-Pro 管理区块，不改动原有 model_instructions_file，适合叠加使用。",
    ...
    : {
        ...
        appendHelp: "Adds a Codex-X-Pro managed block to AGENTS.md without changing the existing model_instructions_file.",
